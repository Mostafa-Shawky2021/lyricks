    ...
    <div className="relative w-full flex flex-col">
      ...
      <div className="absolute inset-0 flex items-center">
        <img
          src={
            artistId
              ? artistData[0]?.attributes?.artwork?.url
                  .replace("{w}", "500")
                  .replace("{h}", "500")
        ...
        <div className="ml-5">
          <p className="text-white font-bold sm:text-3xl text-xl">
            {artistId ? artistData[0]?.attributes?.name : songData?.title}
          </p>
          {!artistId && (
          ...
          <p className="text-gray-400 t-2">
            {artistId
              ? artistData[0]?.attributes?.genreNames[0]
